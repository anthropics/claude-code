 ...
 * 
 * This module uses the Sequential Execution Manager to generate
 * comprehensive documentation for code files.
 */

const path = require('path');
const fs = require('fs');
const SequentialExecutionManager = require('../mcp/integration/sequential_execution_manager');
const logger = require('../../core/logging/logger').createLogger('sequential-doc-generator');
