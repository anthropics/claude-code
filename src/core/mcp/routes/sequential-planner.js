/**
 * Sequential Planner API Routes
 * 
 * These routes provide an interface for the sequential planner hook
 * that integrates sequential thinking, Context7, and 21st-dev-magic.
 */
