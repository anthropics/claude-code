...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <nav
        className="flex h-full flex-col border-r transition-all duration-300 ease-in-out"
        style={{
      ...
      {showFileTree ? (
        ...
        <>
          ...
          {/* Recents Section */}
          <div className="flex-1 overflow-y-auto mt-6" style={{ paddingLeft: '16px', paddingRight: '12px' }}>
            <h3 className="text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-3" style={{ paddingLeft: '16px' }}>
              Recents
            </h3>
          ...
          <div className="relative" style={{ borderTop: '1px solid rgba(31, 30, 29, 0.15)', padding: '12px 16px' }}>
            <div className="flex w-full items-center rounded-md text-sm" style={{ gap: '12px' }}>
              <div style={{ flex: '1 1 0%', minWidth: '0', overflow: 'hidden' }}>
                <div className="text-sm font-medium text-zinc-900" style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{displayName}</div>
                <div className="text-xs text-zinc-500" style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{displayTitle}</div>
              </div>
              {onLogout && (
                <button
                  onClick={onLogout}
