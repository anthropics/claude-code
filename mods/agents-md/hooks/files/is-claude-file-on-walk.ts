 ...
 *
 * What makes a project "have a CLAUDE.md of its own" for `agents-fallback`,
 * the same files the nudge and the Read walk ask for; a rules file, an
 * imported file or an added directory's CLAUDE.md is not one.
 *
