...
export default function MarketCard({ market }: Props) {
  const { question, outcomePrices, outcomes, volume, endDate, sport, slug } =
    market;
  ...
  return (
    <a
      ...
      className="group flex flex-col bg-gray-900 border border-gray-800 rounded-xl p-4 hover:border-indigo-500/60 transition-all duration-200 hover:shadow-lg hover:shadow-indigo-500/10"
    >
