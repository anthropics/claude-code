# fix-scroll-to-top.ps1 (v6 — stdin-only flush)
#
# Buffers ALL Ink renders. Screen updates ONLY when user types.
# No timer. No auto-flush. Zero viewport jumping.
#
...
foreach ($old in @('/* SCROLL_FIX_v2 */', '/* SCROLL_FIX_v4 */', '/* SCROLL_FIX_v5 */')) {
