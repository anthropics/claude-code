...
Check for project type conventions in CLAUDE.md, CONTRIBUTING.md, linter configs, and the existing codebase to understand:
- The project's type system and language conventions (TypeScript interfaces vs types, Go structs, Rust enums, Python dataclasses, etc.)
- Whether the project favors immutable types, builder patterns, or other construction approaches
- Existing patterns for validation, serialization, and error representation
- Any project-specific rules about type organization, naming, or export patterns

Prefer the project's established patterns over universal ideals, but apply both when prudent.
