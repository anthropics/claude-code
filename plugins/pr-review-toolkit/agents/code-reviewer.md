...
- **26-50**: Minor nitpick not explicitly in CLAUDE.md or AGENTS.md
- **51-75**: Valid but low-impact issue
- **76-90**: Important issue requiring attention
- **91-100**: Critical bug or explicit project instruction violation
...
- Specific CLAUDE.md or AGENTS.md rule or bug explanation
