...
1. **Start with the overview**: https://code.claude.com/docs/en/api/agent-sdk/overview
2. **Based on the user's language choice, read the appropriate SDK reference**:
   - TypeScript: https://code.claude.com/docs/en/api/agent-sdk/typescript
   - Python: https://code.claude.com/docs/en/api/agent-sdk/python
...
2. **Useful resources**:
   ...
   - Link to TypeScript SDK reference: https://code.claude.com/docs/en/api/agent-sdk/typescript
   - Link to Python SDK reference: https://code.claude.com/docs/en/api/agent-sdk/python
