...
1. **Start with the overview**: https://code.claude.com/docs/en/agent-sdk/overview
...
2. **Useful resources**:
   ...
   - Link to TypeScript SDK reference: https://code.claude.com/docs/en/agent-sdk/typescript
   - Link to Python SDK reference: https://code.claude.com/docs/en/agent-sdk/python
