...
| [pattern-sweep](./pattern-sweep/) | Search the codebase for patterns similar to a recent bug fix and fix all instances at once | **Command:** `/pattern-sweep` - Reads recent diff, searches for similar buggy patterns, and offers batch fixes |
