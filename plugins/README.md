...
| [notification-sound](./notification-sound/) | Plays a system notification sound when Claude finishes and is waiting for input | **Hooks:** Notification, Stop - Cross-platform sound playback (macOS, Linux, Windows) with configurable sound and volume |
