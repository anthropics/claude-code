...
| [twilight](./twilight/) | Makes specs, plans, and a durable focus stack first-order concepts — spec-first workflow that survives context resets and shifting attention | **Skills:** `design`, `implement` - Spec-first authoring and TDD plan execution<br>**Hooks:** SessionStart, UserPromptSubmit - Inject focus-stack and plan state every session and prompt<br>**Commands:** `/twilight:focus`, `focus-push`, `focus-pop`, `focus-reset` |
