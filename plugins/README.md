...
| [question-optimizer](./question-optimizer/) | Performance optimization plugin that detects simple questions and follow-up queries to suggest faster model usage | **Hook:** UserPromptSubmit - Analyzes each prompt using 4-condition question detection and conversation history matching to recommend Haiku model for follow-up questions |
