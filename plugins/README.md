...
| [remote-control](./remote-control/) | Set up and launch Claude Code Remote Control to continue your local session from any browser or mobile device | **Command:** `/remote-control` - Guided setup and launch with diagnostics<br>**Skill:** `remote-control-guide` - Reference for requirements, usage, and troubleshooting |
