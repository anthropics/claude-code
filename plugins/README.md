...
| [agent-teams-pipeline](./agent-teams-pipeline/) | Lifecycle management for Agent Teams: orphan detection, context-aware shutdown, tmux cleanup, and multi-phase pipeline orchestration | **Hooks:** 7 hooks across PreToolUse, Stop, TeammateIdle, TaskCompleted - Context monitoring, team size limits, orphan detection, deliverable validation<br>**Command:** `/agent-teams-pipeline:cleanup-team-panes` - tmux pane cleanup<br>**Skill:** `pipeline-orchestration` - Multi-phase development protocol |
