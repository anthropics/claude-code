...
| [memory-alert](./memory-alert/) | Monitors system memory usage and alerts when it exceeds a configurable threshold (macOS and Linux) | **Hook:** PostToolUse - Checks memory after each tool call and warns when usage exceeds the configured threshold (default: 5GB) |
