...
| [code-review](./code-review/) | Automated PR code review using four specialized review agents and independent validation to filter false positives | **Command:** `/code-review` - Automated PR review workflow<br>**Agents:** 4 parallel review agents for CLAUDE.md compliance and bug detection, followed by an independent validator for every candidate finding |
