...
| [reframe](./reframe/) | Break through stuck debugging and design problems by reframing them through first principles, inversion, and analogy | **Command:** `/reframe` - Gather codebase context and reframe engineering problems through cognitive frameworks |
