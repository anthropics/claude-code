...
| [mobile-apps](./mobile-apps/) | Organise all apps in a mobile project with a structured, scalable folder layout for React Native, Expo, Flutter, iOS, Android, and monorepos | **Command:** `/mobile-apps:organize` - 7-phase guided workflow to audit, redesign, and apply a clean mobile project structure<br>**Agents:** `mobile-structure-auditor`, `mobile-structure-designer`, `mobile-import-validator` |
