...
| [notify-on-complete](./notify-on-complete/) | Ready-to-use completion notifications for Claude Code stop events | **Hook:** Stop - Plays a sound, desktop notification, or text-to-speech alert when Claude finishes a task |
