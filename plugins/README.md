...
| [protect-mcp](./protect-mcp/) | Fail-closed Cedar policy gate plus Ed25519-signed receipts for tool calls. Blocks policy violations before they run and signs an offline-verifiable receipt of every decision. | **Hooks:** PreToolUse Cedar gate (fail-closed deny), PostToolUse Ed25519 receipt<br>**Skill:** `protect-mcp` setup guidance<br>**MCP:** `protect-mcp serve --enforce` |
