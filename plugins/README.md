...
| [security-guidance](./security-guidance/) | Security review for Claude-generated code: pattern-based warnings on edits, LLM-powered diff review, and an agentic commit reviewer | **Hooks:** PostToolUse - Pattern-based warnings on ~25 dangerous patterns when editing files<br>Stop - LLM-powered diff review of Claude's changes<br>PostToolUse (git commit/push) - Agentic commit security review |
