...
| [email-privacy](./email-privacy/) | Toggle to hide email address from displaying in Claude Code CLI for privacy | **Setting:** `hideEmail` - Masks email address in `/status` and other CLI outputs |
