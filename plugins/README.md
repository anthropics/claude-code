...
| [credential-guard](./credential-guard/) | Detects hardcoded credentials (API keys, tokens, private keys) in file writes and blocks them before they reach disk or version control | **Hook:** PreToolUse - Scans Write/Edit/MultiEdit/NotebookEdit/Bash for 20+ credential patterns (GitHub PATs, AWS keys, Stripe, Slack, PEM keys, database URLs, and more) |
