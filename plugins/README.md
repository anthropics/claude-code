...
| [deny-with-reason](./deny-with-reason/) | Deny tool calls with explanatory reasons so Claude understands and adjusts its approach ([#29782](https://github.com/anthropics/claude-code/issues/29782)) | **Hook:** PreToolUse - Matches tool calls against `.claude/deny-reasons.yaml` rules and denies with a reason sent to Claude as a system message |
