...
| [dream-command](./dream-command/) | Manual memory consolidation — the missing `/dream` command referenced in Claude Code's `/memory` UI | **Command:** `/dream` - Reflective pass to consolidate, deduplicate, and organize memory files |
