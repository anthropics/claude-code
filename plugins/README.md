...
| [performance-analysis](./performance-analysis/) | Comprehensive performance analysis and optimization with specialized agents for bottleneck detection, complexity analysis, memory profiling, and optimization recommendations | **Commands:** `/perf-analyze`, `/perf-profile`, `/perf-compare` - Performance analysis workflows<br>**Agents:** `bottleneck-detective`, `complexity-analyzer`, `memory-profiler`, `concurrency-validator`, `optimization-recommender` - Multi-perspective performance auditing<br>**Skills:** `performance-patterns`, `profiling-tools` - Pattern guidance and language-specific profiling tools |
