...
| [local-shell](./local-shell/) | Intercepts standard shell commands (ls, pwd, watch) typed directly into Claude Code and runs them locally to save tokens and reduce latency | **Hook:** UserPromptSubmit - Blocks the LLM call, runs command locally and returns output |
