...
| [security-guidance](./security-guidance/) | Security review for Claude-generated code in three layers: pattern warnings, LLM diff review, and agentic commit review | **Hooks:** PostToolUse - warns on ~25 known-dangerous patterns on `Edit`/`Write`; Stop - LLM review of the turn diff; SessionStart, UserPromptSubmit |
