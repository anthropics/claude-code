...
| [notify-on-complete](./notify-on-complete/) | Get notified when Claude finishes responding — with a sound, desktop notification, or spoken message. Cross-platform (macOS/Linux), fully configurable | **Hook:** Stop - Plays sound, shows notification, and/or speaks aloud when Claude completes a response |
