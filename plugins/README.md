...
|------|-------------|----------|
| [agents-md](./agents-md/) | AGENTS.md fallback support for cross-tool compatibility with Codex, Cursor, Amp, and others | **Hook:** SessionStart - Loads AGENTS.md files when no CLAUDE.md is present |
