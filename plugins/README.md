...
| [wmux-orchestrator](./wmux-orchestrator/) | Multi-agent task orchestration with wave-based coordination and automated review | **Command:** `/wmux:orchestrate` - Decompose tasks into parallel agents<br>**Skills:** `orchestrate`, `reviewer`, `wmux-detect`<br>**Agent:** `wmux-worker` - Isolated worker with file zone enforcement<br>**Hooks:** PostToolUse, SubagentStop, Stop, SessionStart |
