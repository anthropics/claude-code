...
| [cjk-ime-helper](./cjk-ime-helper/) | Workarounds and utilities for CJK (Chinese, Japanese, Korean) IME input issues in terminal | **Commands:** `/cjk-paste`, `/cjk-status` - Clipboard-based input and environment diagnostics<br>**Hook:** SessionStart - Detects CJK locale and shows workaround tips<br>**Skill:** `cjk-awareness` - CJK-aware interaction behavior |
