...
| [model-router](./model-router/) | Automatically recommends the optimal Claude model before each prompt using a Haiku classifier (~100ms, ~$0.0001/call) | **Hook:** UserPromptSubmit - Classifies task type and complexity, surfaces recommendation banner so you can switch with `/model` |
