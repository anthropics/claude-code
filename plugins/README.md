...
| [data-protection](./data-protection/) | Protects ML checkpoints and training data from accidental overwrites by prompting for user confirmation | **Hook:** PreToolUse - Blocks Write operations on protected file patterns including *.pt, *.pth, *.ckpt, results.csv, metrics.csv, and other ML model/training output files |
