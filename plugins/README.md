...
| [document-skills](./document-skills/) | Document processing skills for Excel, Word, PowerPoint, and PDF files | **Skills:** `xlsx`, `docx`, `pptx`, `pdf` - Auto-invoked for working with common document formats |
| [example-skills](./example-skills/) | Example skills showcasing various Claude capabilities including visual design, generative art, communications, MCP development, and web testing | **Skills:** `algorithmic-art`, `brand-guidelines`, `canvas-design`, `doc-coauthoring`, `frontend-design`, `internal-comms`, `mcp-builder`, `skill-creator`, `slack-gif-creator`, `theme-factory`, `web-artifacts-builder`, `webapp-testing` |
| [claude-api](./claude-api/) | Skill for building applications with the Claude API and Anthropic SDKs | **Skill:** `claude-api` - Auto-invoked when building with the Anthropic API, covering streaming, tool use, vision, and best practices |
