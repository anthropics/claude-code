...
| `--json-schema`                        | Get validated JSON output matching a JSON Schema.<br/><br/>**Bash/PowerShell:**<br/>`claude -p --json-schema '{"type":"object"}' ...`<br/><br/>**Windows CMD:** Use double quotes and escape internals:<br/>`claude -p --json-schema "{\"type\":\"object\"}" ...` | `claude -p --json-schema '{"type":"object","properties":{...}}' "query"`                           |
